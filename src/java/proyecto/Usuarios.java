...
public class Usuarios implements Serializable {
	...
	private java.util.Set this_getSet (int key) {
		...
		else if (key == ORMConstants.KEY_USUARIOS_ANUNCIOSES) {
			return ORM_anuncioses;
		}
	...
	private java.util.Set ORM_anuncioses = new java.util.HashSet();
	...
	private void setORM_Anuncioses(java.util.Set value) {
		this.ORM_anuncioses = value;
	}
	
	private java.util.Set getORM_Anuncioses() {
		return ORM_anuncioses;
	}
	
	public final proyecto.AnunciosSetCollection anuncioses = new proyecto.AnunciosSetCollection(this, _ormAdapter, ORMConstants.KEY_USUARIOS_ANUNCIOSES, ORMConstants.KEY_ANUNCIOS_USUARIOS, ORMConstants.KEY_MUL_ONE_TO_MANY);
