...
public class VisualizarNotasControlador {

    @RequestMapping(method = RequestMethod.GET)
    public ModelAndView visualizarnotas(Model modelo, @RequestParam("id") int id_group, @ModelAttribute("miusuario") Usuarios usuario) {
